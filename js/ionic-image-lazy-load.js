        ...
        return {
            ...
            link: function ($scope, $element, $attributes) {
                ...
                if ($attributes.imageLazyLoader) {
                    var loader = $compile('<div class="image-loader-container"><ion-spinner class="image-loader spinner-assertive" icon="' + $attributes.imageLazyLoader + '"></ion-spinner></div>')($scope);
